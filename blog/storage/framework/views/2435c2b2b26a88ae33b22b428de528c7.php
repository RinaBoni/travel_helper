                              ...
                              <div class="form-group w-50">
                                  ...
                                  <select class="select2" name="tag_ids[]" multiple="multiple"
                                      ...
                                      <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <option
                                              <?php echo e(is_array(old('tag_ids')) && in_array($tag->id, old('tag_ids')) ? 'selected' : ''); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\study\travel_helper\blog\resources\views/admin/post/create.blade.php ENDPATH**/ ?>