    ...
    <header class="edica-header">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand" href="index.html"><img src="<?php echo e(asset('assets/images/logo.svg')); ?>" alt="Edica"></a>
        ...
        <div class="container">
            <div class="footer-banner" data-aos="fade-up">
                ...
                <div class="banner-btns-wrapper">
                    <button class="btn btn-success"> <img src="<?php echo e(asset('assets/images/apple@1x.svg')); ?>" alt="ios" class="mr-2"> App Store</button>
                    <button class="btn btn-success"> <img src="<?php echo e(asset('assets/images/android@1x.svg')); ?>" alt="android" class="mr-2"> Google Play</button>
                </div>
...
<?php /**PATH C:\study\travel_helper\blog\resources\views/layouts/main.blade.php ENDPATH**/ ?>