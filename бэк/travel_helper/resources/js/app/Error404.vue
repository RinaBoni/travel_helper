    ...
    <div class="flex flex-column align-items-center justify-content-center">
      <div
        ...
        <div class="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center"
          ...
          <h1 class="text-900 font-bold text-3xl lg:text-5xl mb-2">Страница не найдена!</h1>
          <div class="text-600 mb-5">Ошибка</div>
          <router-link to="/app/" class="w-full flex align-items-center mb-5 py-5 border-300 border-bottom-1">
            ...
            <span class="ml-4 flex flex-column">
              <span class="text-900 lg:text-xl font-medium mb-0">Главная</span>
            </span>
          </router-link>
        </div>
      </div>
